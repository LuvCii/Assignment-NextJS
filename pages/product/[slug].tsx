...
const ProductDetail = (props: Props) => {
  ...
  const { data, error } = useSWR(slug ? `/product/${slug}` : null);
              ...
              <div className="grid grid-cols-12 pt-4 pb-3 ">
                <div className="col-span-3">
                  <form>
                    <input
                      type="number"
                      className=" text-center border-2 pl-8 border-gray-200 py-2 rounded-lg"
                      placeholder="1"
                      min="1"
                    />
                  </form>
                ...
                <div className="col-span-8 pl-24">
                  <button className="text-center py-2  border border-black rounded-lg px-8 hover:bg-black hover:text-white">
                    Add to cart
                  </button>
                </div>
              </div>
                ...
                <div className="mb-2 flex justify-around">
                  <div>
                    <del className="text-red-500">
                      <p className="mt-1 italic text-sm text-red-500">
                        200 000 VNĐ
                      </p>
                    </del>
                  </div>
